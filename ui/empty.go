...
func (e *EmptyWidget) Layout(c ggui.Constraints, env ggui.Env) ggui.Size {
	...
	e.box = ggui.Box(ggui.Row(ggui.Column(parts...).Gap(t.Space).Align(ggui.AlignCenter)).Justify(ggui.JustifyCenter)).Padding(t.CardPad).Border(t.BorderWidth, t.Border).Radius(t.Radius)
